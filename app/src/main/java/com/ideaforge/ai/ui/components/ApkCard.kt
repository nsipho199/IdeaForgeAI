        ...
        Column(
            ...
            Row(
                ...
                Column(modifier = Modifier.weight(1f)) {
                    ...
                    Text(
                        text = "v1.0 \u2022 ${TimeUtils.formatFileSize(build.apkSize)}",
            ...
            Text(
                text = "Built on ${TimeUtils.formatTimestamp(build.completedAt)}",
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
            ...
            Row(
                ...
                OutlinedButton(
                    ...
                    Icon(Icons.Default.InstallMobile, contentDescription = null, modifier = Modifier.padding(end = 4.dp))
                    Text("Install")
                }
                OutlinedButton(
                    onClick = onShare,
